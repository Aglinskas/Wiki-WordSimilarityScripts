function [denseMatrices, remainedTargWords, copScores, silScores] = hc_eliminateSamples_recursion_aggressive(dm, targWords, n_iterations,...
    n_clusters,max_cluster_size, min_cluster_size, showDeletedItems,plotSil)
...
%         (dm, targWords, showDeletedItems, n_clusters, 'negSil');
...
targWords(Siter<0)=[];
    ...
    [dm, targWords, futileKiller] = hc_truncateDenseMatrix...
        (dm, targWords, showDeletedItems, n_clusters, 'elementwise', max_cluster_size, min_cluster_size);
